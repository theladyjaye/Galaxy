	...
	<div>
		<?php foreach ($messages as $message): ?>
			...
			<div style="padding-top:10px">
				<div style="background-color:#efefef; padding:7px"><?php echo $message->title ?> | <a href="/moderator/message_edit.php?id=<?php echo $channel.'.'.$message->id ?>">Edit Message</a></div>
