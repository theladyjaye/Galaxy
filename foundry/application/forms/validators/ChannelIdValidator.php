<?php
class ChannelIdValidator extends AMValidator
{
	// com.galaxy.community.channels
	private $pattern = '/^(com|org|net|edu)\.[a-z0-9][a-z0-9-]{2,}\.[a-z0-9][a-z0-9-]{2,}\.[a-z0-9][a-z0-9-]{2,}$/';
